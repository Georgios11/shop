...
export const getAllProducts = async (
  ...
  try {
    ...
    //   await paginate(pageNumber, Product, 'products', keyword);

    // responseUtils.successResponse(
    //   res,
    //   StatusCodes.OK,
    //   `Returned products ${startIndex}-${endIndex} of ${count}`,
    //   { products: documents, pageNumber, pages: availablePages }
    // );
  ...
  try {
    ...
    const emailData = {
      ...
      html: `
            ...
            <p>Please click here to <a href="${clientUrl}/activate/${token}" >activate your account</a></p>
        `,
    };
